...
const KEYS = {
  ...
  lastRun: "dl_lastRun",
  handoffPackage: "dl_agent7_handoffPackage",
} as const;
...
export const loadPipelineState = (): PersistedPipelineState => {
  ...
  return {
    ...
    handoffPackage: safe<HandoffPackage>(KEYS.handoffPackage),
  };
};
...
// Add save function
export const saveHandoffPackage = (data: HandoffPackage) => {
  localStorage.setItem(KEYS.handoffPackage, JSON.stringify(data));
};